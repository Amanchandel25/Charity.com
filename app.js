...
const checksum_lib = require("/complete web development/charity/Paytm/checksum");
const config = require("/complete web development/charity/Paytm/config");
...
app.get("/contact", (req, res) => {
  ...
  app.post("/paynow", [parseUrl, parseJson], (req, res) => {
    ...
    if (!paymentDetails.amount || !paymentDetails.customerId || !paymentDetails.customerEmail || !paymentDetails.customerPhone) {
      ...
      myData.save();
      var params = {};
      params['MID'] = 'abacVn91311083591847';
